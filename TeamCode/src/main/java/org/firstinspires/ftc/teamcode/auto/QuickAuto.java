...
public class QuickAuto extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectoryActionBuilder tab4 = drive.actionBuilder(new Pose2d(38, -62, ninety))
                .splineToSplineHeading(new Pose2d(-4, -31, twoSeventy), ninety); // goes to hook the first picked up block

        TrajectoryActionBuilder tabIntermediate2 = drive.actionBuilder(new Pose2d(-4, -31, twoSeventy))
                .strafeToConstantHeading(new Vector2d(-4, -28)); // goes in closer to properly hook

        TrajectoryActionBuilder tab5 = drive.actionBuilder(new Pose2d(-4, -28, twoSeventy))
                .strafeToSplineHeading(new Vector2d(30, -61), ninety); // goes to the pickup position for the second block

        TrajectoryActionBuilder tab6 = drive.actionBuilder(new Pose2d(30, -61, ninety))
                .splineToSplineHeading(new Pose2d(10, -34, twoSeventy), ninety); // goes to the bar
