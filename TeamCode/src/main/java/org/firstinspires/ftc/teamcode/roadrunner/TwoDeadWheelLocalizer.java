...
import org.firstinspires.ftc.teamcode.roadrunner.rrmessages.TwoDeadWheelInputsMessage;

@Config
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -2417.281043057148; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 651.5495996153463; // x position of the perpendicular encoder (in tick units)
    }
