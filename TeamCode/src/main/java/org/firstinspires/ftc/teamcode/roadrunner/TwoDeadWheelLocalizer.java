...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 2150.0244368947033; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 2868.0329831847125; // x position of the perpendicular encoder (in tick units)
    }
